function select_state_func()
{
		...
		{
		document.getElementById("citypid").innerHTML="<select name='city' id='cityid' class='form-control validate[required]'><option value='' selected='selected'>Select</option><option value='Itanagar' >Itanagar</option>\
...
<option value='Rajnandgaon' >Rajnandgaon</option></select>";
		...
		<option value='Central 11' >Central 11</option>\
...
<option value='Wadhwan' >Wadhwan</option></select>";
		...
		else if (typevalue == 11)
		{
			...
			<option value='Yamuna Nagar' >Yamuna Nagar</option></select>";
		}
...
<option value='Chitrakoot' >Chitrakut Dham</option>\
